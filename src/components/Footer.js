      ...
      <Container>
        <Grid container spacing={4} sx={{ mb: 4 }}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <Typography variant="body2" color="rgba(255,255,255,0.7)">Email: info@shophub.ke</Typography>
        ...
        <Box sx={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 3, textAlign: 'center' }}>
          <Typography variant="body2" color="rgba(255,255,255,0.6)">
            © 2026 ShopHub Kenya. All rights reserved. | Privacy Policy | Terms of Service
          </Typography>
        </Box>
      </Container>
    </Box>
